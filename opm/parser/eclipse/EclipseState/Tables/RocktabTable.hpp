...
namespace Opm {
    ...
    public:
                     ...
                     bool hasStressOption)
        {
            ...
            if (isDirectional) {
                m_schema->addColumn( ColumnSchema("PV_MULT_X" , Table::RANDOM , Table::DEFAULT_LINEAR ) );
                m_schema->addColumn( ColumnSchema("PV_MULT_Y" , Table::RANDOM , Table::DEFAULT_LINEAR ) );
                m_schema->addColumn( ColumnSchema("PV_MULT_Z" , Table::RANDOM , Table::DEFAULT_LINEAR ) );
            } else
                m_schema->addColumn( ColumnSchema("PV_MULT" , Table::RANDOM , Table::DEFAULT_LINEAR ) );
