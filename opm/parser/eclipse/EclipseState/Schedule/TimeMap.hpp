...
namespace Opm {
    ...
    public:
        ...
        void getFirstTimestepsMonths(std::vector<size_t>& timesteps, size_t timestep=0) const;
        /// Return a list of the first timesteps of each year
        void getFirstTimestepsYears(std::vector<size_t>& timesteps, size_t start_timestep=0) const;
