...
BOOST_AUTO_TEST_CASE(TimeStepsCorrect) {
    ...
    tmap.getFirstTimestepsMonths(first_timestep_of_each_month);
    ...
    tmap.getFirstTimestepsMonths(first_timestep_of_each_month, 5);
    ...
    tmap.getFirstTimestepsYears(first_timestep_of_each_year);
    ...
    tmap.getFirstTimestepsYears(first_timestep_of_each_year, 6);
